        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4>Category list
                    <a href="{{ url('add-category') }}" class="btn btn-primary float-end">Add Category</a></h4>
                </div>
                <div class="card-body">
                              ...
                              @foreach ($category as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ url('delete-category/'.$item->id) }}" method="POST" accept-charset="UTF-8" style="display:inline">
                                            @csrf
